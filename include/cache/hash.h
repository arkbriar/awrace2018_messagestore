...
#ifndef QUEUE_RACE_HASH_H
#define QUEUE_RACE_HASH_H
...
inline static void hash_x86_128(const void *key, const int len, uint32_t seed, void *out) {
...
inline static void hash_x64_128(const void *key, const int len, const uint32_t seed, void *out) {
    const uint8_t *data = (const uint8_t *)key;
    const int nblocks = len / 16;
...
inline void hash128(const void *key, const int len, const uint32_t seed, uint64_t out[2]) {
